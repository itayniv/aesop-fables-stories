# -*- coding: utf-8 -*-
"""Copy of Semantic_Similarity_with_TF_Hub_Universal_Encoder - save.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1iJUWIIjOW1_PmQOaF9S-N0wxR3cngRo0
...
"You must be very glad to have me go now, he said.", "It's all the same to me, replied the Bull.",
...
"Then off he swam with him toward the shore.", "The Monkey sat up, grave and dignified, on the Dolphin's back.",
...
"Under his kindly appearance, he bears a grudge against every one of us.", "The other was nothing but a bird who wouldn't harm you in the least.",
...
"Not one did she spare.", "The Eagle's grief and anger knew no bounds, but who had done the cruel deed she did not know.",
...
"Though he was well fed, he had much work to do; besides, the Master hardly ever took any notice of him.", "Now the jealous Ass got it into his silly head that all he had to do to win his Master's favor was to act like the Dog.",
...
"But though the little one continued to fret, the Wolf waited all day in vain.", "Then, toward nightfall, he heard the Mother's voice again as she sat down near the window to sing and rock her baby to sleep.",
...
"A Kite saw her. Why do you look so woebegone?",
"asked the Kite.", "I want to get married, replied the Eagle, and I can't find a mate who can provide for me as I should like.",
...
"Then, though the Tiger, the Bear, the Wolf, and all the savage beasts recited the most wicked deeds, all were excused and made to appear very saint-like and innocent.", "It was now the Ass's turn to confess.",
...
with tf.Session() as session:
  ...
  for i, message_embedding in enumerate(np.array(message_embeddings).tolist()):
    # as you llop through embeddings add everything to the object
    item = {}
#    print("Message: {}".format(messages[i]))
    item['message'] = messages[i]
    item['message_embedding'] = message_embedding
    stuff.append(item)
...
!head outputfile.json

files.download('outputfile.json')
...
"He wanted to see the world too, and there he was with a house on his back and little short legs that could hardly drag him along.", "One day he met a pair of Ducks and told them all his trouble.",
"We can help you to see the world, said the Ducks.",
"Take hold of this stick with your teeth and we will carry you far up in the air where you can see the whole countryside.",
"But keep quiet or you will be sorry.",
"The Tortoise was very glad indeed.",
